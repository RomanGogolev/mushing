...
<div class="container">
    <form class="form-horizontal" method="post" action="${contextPath}/reports/upload" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <a href="${contextPath}/reports/download?filename=${file.name}">${file.name}<BR>
                </c:forEach>
        </div>
    </div>
</div>
